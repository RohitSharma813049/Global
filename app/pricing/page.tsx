  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-12 text-center">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 mb-6">Pricing Plans</h1>
        <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
          We are finalizing our subscription tiers for scholars and institutions. Check back soon for details on our open-access and premium features.
        </p>
      </main>
      <Footer />
    </div>

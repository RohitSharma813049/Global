  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-12 text-center">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 mb-6">Saved Papers</h1>
        <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto mb-10">
          You haven't saved any papers yet. When you find an interesting paper, click the "Save to Library" button to bookmark it here.
        </p>

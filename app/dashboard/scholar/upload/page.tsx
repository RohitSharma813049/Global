  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Submit your thesis, article, or eBook to the Global Scholar Publications platform.</p>
      </div>
          ...
          {stepTitles.map((title, index) => {
            ...
            return (
              <div key={index} className="relative z-10 flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 transition-colors duration-300 ${isActive ? 'bg-[#2F115D] border-[#2F115D] text-white' : isCompleted ? 'bg-[#2F115D] border-[#2F115D] text-white opacity-80' : 'bg-white border-gray-300 text-gray-400'}`}>
                  {isCompleted ? '✓' : stepNum}
                </div>
                <div className={`absolute top-12 text-xs font-medium whitespace-nowrap hidden sm:block ${isActive || isCompleted ? 'text-gray-900' : 'text-gray-400'}`}>
                  {title}
                </div>
              </div>
            );
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sm:mt-16">
        <div className="p-6 sm:p-8">
          ...
          <form id="uploadForm" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input aria-label="Input field" 
                    ...
                    className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" 
                  />
                </div>
                <div>
                  ...
                  <select aria-label="Select field" 
                    ...
                    id="content_type" 
                    required={currentStep === 1}
                    className="mt-1 block w-full px-4 py-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
                  >
            ...
            <div id="step-2" className={currentStep === 2 ? 'block' : 'hidden'}>
              <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-2">Author Details</h2>
              <div className="space-y-6">
            ...
            <div id="step-3" className={currentStep === 3 ? 'block' : 'hidden'}>
              <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-2">Content & Abstract</h2>
              <div className="space-y-6">
                <div>
            ...
            <div id="step-4" className={currentStep === 4 ? 'block' : 'hidden'}>
              <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-2">Media & Files</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-emerald-500 transition-colors bg-gray-50">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600 justify-center">
                        <label htmlFor="file" className="relative cursor-pointer bg-white rounded-md font-medium text-emerald-600 hover:text-emerald-500 px-2 py-1 shadow-sm border">
                      ...
                      <p className="text-xs text-gray-500">Required: PDF, DOCX, EPUB up to 5MB</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="cover_image" className="block text-sm font-medium text-gray-700">Cover Photo</label>
                    <div className="mt-1 flex justify-center px-4 py-4 border-2 border-gray-300 border-dashed rounded-md hover:border-emerald-500 bg-gray-50">
                  ...
                  <div>
                    <label htmlFor="banner_image" className="block text-sm font-medium text-gray-700">Banner Image</label>
                    <div className="mt-1 flex justify-center px-4 py-4 border-2 border-gray-300 border-dashed rounded-md hover:border-emerald-500 bg-gray-50">
                      <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="video_file" className="block text-sm font-medium text-gray-700">Main Video</label>
                    <div className="mt-1 flex justify-center px-4 py-4 border-2 border-gray-300 border-dashed rounded-md hover:border-emerald-500 bg-gray-50">
                      <div className="text-center">
            ...
            <div id="step-5" className={currentStep === 5 ? 'block' : 'hidden'}>
              <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-2">Declarations</h2>
              <div className="space-y-4 bg-gray-50 p-6 rounded-lg border border-gray-200">
                <div className="flex items-start">
                  ...
                  <label htmlFor="originality_declaration" className="ms-3 text-sm font-medium text-gray-900 leading-relaxed">
                ...
                <div className="flex items-start mt-4">
                  ...
                  <label htmlFor="copyright_declaration" className="ms-3 text-sm font-medium text-gray-900 leading-relaxed">
                ...
                <div className="flex items-start mt-4">
                  ...
                  <label htmlFor="terms_acceptance" className="ms-3 text-sm font-medium text-gray-900 leading-relaxed">
            ...
            <div className="pt-6 mt-6 border-t border-gray-200 flex items-center justify-between">
              <button
                type="button"
                onClick={prevStep}
                className={`py-2 px-6 rounded-md font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors ${currentStep === 1 ? 'opacity-0 pointer-events-none' : ''}`}
              >
                Back
              </button>
              ...
              {currentStep < 5 ? (
                <button
                  type="button"
                  onClick={nextStep}
                  className="py-2 px-8 rounded-md font-medium text-white bg-[#2F115D] hover:bg-[#3d167a] shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2F115D] transition-colors"
                >
                  Continue
                </button>
              ) : (
                <button
                  type="submit"
                  disabled={loading}
                  className="py-2 px-8 rounded-md font-medium text-white bg-emerald-600 hover:bg-emerald-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors disabled:opacity-50"
                >

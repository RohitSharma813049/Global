      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-8 border-b border-slate-100 flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-bold text-slate-900 mb-2">Google Calendar Integration</h1>
              <p className="text-slate-500">Sync your meetings and site visits with Google Calendar</p>
            </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-700">Not Connected</span>
            </div>

            {/* Benefits Box */}
            <div className="bg-blue-50/80 border border-blue-100 rounded-xl p-5 text-blue-800">
            ...
            <div className="text-center">
              <button className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-sm transition-colors flex items-center justify-center gap-2 text-lg">

      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3 sm:gap-4 text-sm font-medium">
            <span className="flex items-center cursor-pointer transition-all px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/20 text-white/90 hover:text-white backdrop-blur-md border border-white/10 shadow-sm">By Author</span>
            <span className="flex items-center cursor-pointer transition-all px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/20 text-white/90 hover:text-white backdrop-blur-md border border-white/10 shadow-sm">By Subject</span>
            <span className="flex items-center cursor-pointer transition-all px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/20 text-white/90 hover:text-white backdrop-blur-md border border-white/10 shadow-sm">By Year</span>
            <span className="flex items-center cursor-pointer transition-all px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/20 text-white/90 hover:text-white backdrop-blur-md border border-white/10 shadow-sm">By Publication Type</span>
          </div>
        </motion.div>
      </div>
    </section>

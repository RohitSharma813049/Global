        ...
        <div className="grid gap-10 lg:gap-12 lg:grid-cols-2 items-center">
          ...
          <div className="flex flex-col justify-between h-full py-2 sm:py-4">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight tracking-tight transition-colors cursor-pointer line-clamp-2 min-h-16 sm:min-h-22">
                {current.title}
              </h3>
